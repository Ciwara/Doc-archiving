...
from Common.ui.common import (FWidget, FPageTitle, FormLabel, PyTextViewer,
                              Button_menu, FPageTitle, FLabel, Button, LineEdit,
                              Button_save)
...
class HomeViewWidget(FWidget):
    ...
    def __init__(self, parent=0, *args, **kwargs):
        ...
        self.parentWidget().setWindowTitle(
            Constants.APP_NAME + blanck + "MENU GENERAL")
        ...
        self.consultation.setIcon(
            QIcon.fromTheme('save', QIcon(u"{}archive.png".format(Constants.img_media))))

        self.add_archiv = Button_menu(_("Archivage"))
        # Affiche sur le commentaire sur le status bar
        # add_archiv.setStatusTip("hhhhhh")
        self.add_archiv.setIcon(QIcon.fromTheme(
            'save', QIcon(u"{}archive_add.png".format(Constants.img_media))))
        ...
        self.admin.setIcon(
            QIcon.fromTheme('save', QIcon(u"{}admin.png".format(Constants.img_media))))
    ...
    def goto_consultation(self):
        self.check_log(ConsultationViewWidget)
    ...
    def add_lience(self):
        ...
        if self.flog:
            ...
            sttg.save()
            self.Notify(u"""La license (<b>{}</b>) à éte bien enregistré pour cette machine.\n
                           Elle doit être bien gardé""".format(license), "succes")
            self.goto_archi()
